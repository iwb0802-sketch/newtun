    ...
    <div className={cn(
      ...
      <header className={cn(
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className={cn("text-base font-bold leading-tight", isComposite3 ? "text-white" : "text-foreground")}>신규</h1>
        ...
        <nav className={cn(
          ...
          <span className="shrink-0 px-3 py-1 text-xs font-bold rounded-md bg-card text-precision shadow-sm">신규</span>
          <Link to="/strobe-manual" className="shrink-0 px-3 py-1 text-xs font-medium rounded-md text-muted-foreground hover:text-foreground transition-colors">시험용(구버전)</Link>
          <Link to="/strobe-manual-2" className="shrink-0 px-3 py-1 text-xs font-medium rounded-md text-muted-foreground hover:text-foreground transition-colors">시험용(신버전)</Link>
        </nav>
      </header>
