      ...
      >
        ...
        <div className="flex items-center gap-2">
          <nav className="flex items-center gap-1 bg-muted rounded-lg p-0.5">
            ...
            <Link to="/strobe-manual-2" className="px-2.5 py-1 text-[11px] font-medium rounded-md text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap leading-none">시험용(신버전)</Link>
          </nav>
          <button
